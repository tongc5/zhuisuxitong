...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_物料编码搜索框'), GlobalVariable.material_Id)
...
WebUI.verifyElementAttributeValue(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行物料编码数据'), 'title', GlobalVariable.material_Id, 
    0)

'测试步骤2'
WebUI.comment('2.输入三个字段查询')

'预期结果2'
WebUI.comment('2.查询结果正确')

WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_订单编号搜索框'), GlobalVariable.order_num)
...
WebUI.verifyElementAttributeValue(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行订单编号数据'), 'title', GlobalVariable.order_num, 
    0)

'测试步骤3'
WebUI.comment('3.输入四个字段查询')

'预期结果3'
WebUI.comment('3.查询结果正确')

WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_设备机号底盘机号搜索框'), GlobalVariable.device_num)
...
WebUI.verifyElementAttributeValue(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行设备机号数据'), 'title', GlobalVariable.device_num, 
    0)
