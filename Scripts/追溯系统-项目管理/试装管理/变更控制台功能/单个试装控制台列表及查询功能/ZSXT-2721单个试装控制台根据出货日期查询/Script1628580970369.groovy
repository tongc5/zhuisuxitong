...
WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_出货日期搜索框'))

WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_出货日期输入框'), GlobalVariable.start_date)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/div_31'))

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/button_查询'))

WebUI.delay(GlobalVariable.wait_short)

WebUI.verifyElementAttributeValue(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行出货日期数据'), 'title', GlobalVariable.start_date, 
    0)

'测试步骤2'
WebUI.comment('2.输入不存在的出货日期')
...
WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_出货日期搜索框'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_出货日期输入框'), GlobalVariable.start_date_notExsit)
