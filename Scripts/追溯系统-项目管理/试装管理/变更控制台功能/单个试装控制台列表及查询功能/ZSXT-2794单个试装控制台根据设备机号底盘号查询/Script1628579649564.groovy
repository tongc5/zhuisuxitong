...
WebUI.delay(GlobalVariable.wait_mid)
...
'测试步骤2'
WebUI.comment('2.输入不存在的设备机号/底盘号')
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_设备机号底盘机号搜索框'), GlobalVariable.device_num_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_设备机号底盘机号搜索框'), GlobalVariable.device_num1)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/button_查询'))

WebUI.delay(GlobalVariable.wait_short)

deviceNum = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行设备机号数据'), 'title')

CustomKeywords.'custom.sampleKeywords.containStr'(deviceNum, GlobalVariable.device_num1)
