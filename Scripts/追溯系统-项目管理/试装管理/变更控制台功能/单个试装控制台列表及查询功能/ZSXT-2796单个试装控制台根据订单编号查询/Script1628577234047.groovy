...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_订单编号搜索框'), GlobalVariable.order_num_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_订单编号搜索框'), GlobalVariable.order_num1)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/button_查询'))

WebUI.delay(GlobalVariable.wait_short)

orderNum = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行订单编号数据'), 'title')

CustomKeywords.'custom.sampleKeywords.containStr'(orderNum, GlobalVariable.order_num1)
