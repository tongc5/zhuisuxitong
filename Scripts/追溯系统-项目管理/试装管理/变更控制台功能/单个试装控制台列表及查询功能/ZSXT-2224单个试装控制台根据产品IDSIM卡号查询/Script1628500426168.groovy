...
'测试步骤1'
WebUI.comment('1.输入存在的产品ID/SIM卡号')
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_产品IDSIM卡号搜索框'), GlobalVariable.product_Id)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/button_查询'))

WebUI.delay(GlobalVariable.wait_short)

WebUI.verifyElementAttributeValue(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行产品ID数据'), 'title', GlobalVariable.product_Id, 
    0)

'测试步骤2'
WebUI.comment('2.输入不存在的产品ID/SIM卡号')
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_产品IDSIM卡号搜索框'), GlobalVariable.product_Id_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_产品IDSIM卡号搜索框'), GlobalVariable.product_Id1)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/button_查询'))

WebUI.delay(GlobalVariable.wait_short)

productId = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行产品ID数据'), 'title')

CustomKeywords.'custom.sampleKeywords.containStr'(productId, GlobalVariable.product_Id1)
