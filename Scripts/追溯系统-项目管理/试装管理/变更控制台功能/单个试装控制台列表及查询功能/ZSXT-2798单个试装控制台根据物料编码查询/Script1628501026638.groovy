...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_物料编码搜索框'), GlobalVariable.material_Id_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_物料编码搜索框'), GlobalVariable.material_Id1)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/button_查询'))

WebUI.delay(GlobalVariable.wait_short)

materialId = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行物料编码数据'), 'title')

CustomKeywords.'custom.sampleKeywords.containStr'(materialId, GlobalVariable.material_Id1)
