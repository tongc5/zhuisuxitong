...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_客户流向状态搜索框'), GlobalVariable.Customer_flow)
...
WebUI.verifyElementAttributeValue(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/td_试装控制台第一行客户流向状态数据'), 'title', GlobalVariable.Customer_flow, 
    0)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_客户流向状态搜索框'), customerFlow1)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/试装控制台/input_产品IDSIM卡号搜索框'))
