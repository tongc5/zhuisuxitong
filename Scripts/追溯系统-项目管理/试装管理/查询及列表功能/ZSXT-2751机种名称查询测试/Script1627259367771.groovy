...
modelName1 = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/试装管理/td_机种名称第一行数据'), 'title')

WebUI.verifyEqual(modelName1, GlobalVariable.model_name)

'测试步骤2'
WebUI.comment('2.输入不存在的机种名称查询')
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/input__机种名称搜索框'), GlobalVariable.model_name_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/试装管理/input__机种名称搜索框'), GlobalVariable.model_name1)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/试装管理/button_查询'))

WebUI.delay(5)

modelName2 = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/试装管理/td_机种名称第一行数据'), 'title')

CustomKeywords.'custom.sampleKeywords.containStr'(modelName2, GlobalVariable.model_name1)
