...
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/系统管理/回收站/td_回收站第一行数据为变更管理'), 0)

WebUI.click(findTestObject('追溯系统/业务管理/系统管理/回收站/a_第一行数据查看'))

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/系统管理/回收站/input__回收站变更管理变更编码为全局变量'), 0)
