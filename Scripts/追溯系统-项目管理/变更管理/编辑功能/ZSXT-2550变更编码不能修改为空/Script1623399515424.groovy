...
WebUI.sendKeys(findTestObject('追溯系统/业务管理/项目管理/变更管理/编辑/input__变更编码输入框'), Keys.chord(Keys.CONTROL, 'a', Keys.DELETE))

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/变更管理/编辑/button_编辑-确定'))

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/项目管理/变更管理/编辑/div_请输入变更编码'), 5)
