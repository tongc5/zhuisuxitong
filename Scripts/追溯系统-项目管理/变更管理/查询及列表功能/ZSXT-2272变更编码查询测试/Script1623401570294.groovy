...
changeId1 = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/变更管理/td_变更编码第一行数据'), 'title')
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/变更管理/input__变更编码搜索框'), GlobalVariable.changeId_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/变更管理/input__变更编码搜索框'), GlobalVariable.changeId2)

WebUI.click(findTestObject('追溯系统/业务管理/项目管理/变更管理/button_查询'))

WebUI.delay(5)

changeId2 = WebUI.getAttribute(findTestObject('追溯系统/业务管理/项目管理/变更管理/td_变更编码第一行数据'), 'title')
