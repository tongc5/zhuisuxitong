...
'检查是否查询到变更信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/项目管理/变更管理/td_变更人第一行数据包含change_person'), 5)

'测试步骤2'
WebUI.comment('2.输入不存在的变更人查询')
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/变更管理/input_变更人搜索框'), GlobalVariable.change_person_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/项目管理/变更管理/input_变更人搜索框'), GlobalVariable.change_person1)
...
'检查是否查询到变更信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/项目管理/变更管理/td_变更人第一行数据包含change_person1'), 5)
