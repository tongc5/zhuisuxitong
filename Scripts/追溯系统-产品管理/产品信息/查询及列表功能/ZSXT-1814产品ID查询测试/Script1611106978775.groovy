...
'测试步骤1'
WebUI.comment('1.在产品ID文本框中输入存在的产品ID,点击查询按钮')
...
'测试步骤2'
WebUI.comment('2.在产品ID文本框中输入不存在的产品ID,点击查询按钮')
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/产品信息/input_-产品信息-产品id,SIM卡号'), GlobalVariable.product_Id_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/产品信息/input_-产品信息-产品id,SIM卡号'), GlobalVariable.product_Id1)
...
'检查是否模糊查询成功'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/产品信息/td_22000'), 5)
