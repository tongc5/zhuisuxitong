...
'检查是否查询到产品信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/产品信息/td_SEED-10IA-55机种名称元素'), 5)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/产品信息/input__ant-input机种名称搜索框'), GlobalVariable.model_name_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/产品信息/input__ant-input机种名称搜索框'), GlobalVariable.model_name1)
...
'检查是否模糊查询成功'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/产品信息/td_SEED-10IA-55机种名称元素2'), 5)
