...
'检查是否查询到产品信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/产品信息/td_240703000013A物料编码元素'), 5)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/产品信息/input__ant-input物料编码搜索框'), GlobalVariable.material_Id_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/产品信息/input__ant-input物料编码搜索框'), GlobalVariable.material_Id1)
...
'检查是否模糊查询成功'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/产品信息/td_240703000013A物料编码元素2'), 5)
