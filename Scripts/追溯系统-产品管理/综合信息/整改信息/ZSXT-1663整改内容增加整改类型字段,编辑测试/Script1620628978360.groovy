...
'测试步骤1'
WebUI.comment('1.打开产品管理-综合信息-整改信息页面，编辑整改信息，有预期结果1')

'预期结果1'
WebUI.comment('1.整改编辑页面增加整改类型下列框，该字段为“必填项”，录入模式为“可手动输入、可下拉选择”，可选择项有：“技改”、“整改”“测试”、“调试”、“产品改制”、“试装”、“协调”、“外销”、“信息记录”')
...
WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/整改信息/button_编辑-确定'))
