...
'测试步骤1'
WebUI.comment('1.依次每个状态，点击查询')

'预期结果1'
WebUI.comment('1.下方结果列表显示对应状态的信息')
...
'测试步骤2'
WebUI.comment('2.点击多个状态，点击查询')

'预期结果2'
WebUI.comment('2.下方结果列表显示对应多个状态的信息')
...
WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/li_待回司'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/button_查询'))

WebUI.delay(5)

status1 = WebUI.getAttribute(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/故障状态第一行数据'), 'title')

status2 = WebUI.getAttribute(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/故障状态第二行数据'), 'title')

CustomKeywords.'custom.sampleKeywords.betweenTwoString'('待更换', '待回司', status1)

CustomKeywords.'custom.sampleKeywords.betweenTwoString'('待更换', '待回司', status2)

'测试步骤3'
WebUI.comment('3.输入不存在的状态')

'预期结果3'
WebUI.comment('3.下拉框无状态可供选择')

WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/button_清除'))

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/状态搜索框-输入'), 'test001')
...
'测试步骤4'
WebUI.comment('4.输入存在的状态，比如关闭')

'预期结果4'
WebUI.comment('4.下拉框显示输入字符的状态，比如已关闭，待关闭')

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/状态搜索框-输入'), '待更换')

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/li_待更换'), 0)
