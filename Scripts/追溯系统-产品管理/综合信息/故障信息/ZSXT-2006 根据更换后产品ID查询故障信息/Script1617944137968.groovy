...
'测试步骤1'
WebUI.comment('1.更换后产品ID输入框输入存在的更换后产品ID，点击查询')

'预期结果1'
WebUI.comment('1.下方结果列表显示对应更换后产品ID的信息')
...
'测试步骤2'
WebUI.comment('2.在更换后产品ID输入框输入不存在的更换后产品ID,点击查询')
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/更换后产品ID搜索框'), GlobalVariable.product_Id_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/更换后产品ID搜索框'), '_.')
...
'测试步骤4'
WebUI.comment('4.输入存在的更换后产品ID的部分，点击查询')

'预期结果4'
WebUI.comment('4.下方结果列表显示部分对应更换后产品ID的信息(模糊查询)')

WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/button_清除'))

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/更换后产品ID搜索框'), GlobalVariable.productId_replace1)

WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/button_查询'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/故障信息/td_展示数据中包含替换后产品ID模糊查询数据'), 0)
