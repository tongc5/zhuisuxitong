...
'测试步骤1'
WebUI.comment('1.导出，查看文件')

'预期结果1'
WebUI.comment('1.文件可正常打开')

'测试步骤2'
WebUI.comment('2.查看导出内容')

'预期结果2'
WebUI.comment('2.跟列表数据一致')
...
WebUI.comment('检查是否已存在报废信息，没有就新建一个')
...
WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/报废信息/button_导出'))
...
WebUI.verifyElementPresent(findTestObject('追溯系统/下载/div_报废导出完成'), 0)
