...
WebUI.sendKeys(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/input_产品ID输入框'), Keys.chord(Keys.CONTROL, 'a', Keys.DELETE))

WebUI.comment('产品ID不允许修改')

WebUI.verifyElementAttributeValue(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/input_产品ID输入框'), 'value', GlobalVariable.product_Id, 
    0)
