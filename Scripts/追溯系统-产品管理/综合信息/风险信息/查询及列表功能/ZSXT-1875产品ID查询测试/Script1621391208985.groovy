...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/input_产品ID搜索框'), GlobalVariable.product_Id1)
...
'检查是否查询到产品信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/a_22000'), 5)

'测试步骤2'
WebUI.comment('2.输入存在的产品ID可以搜索到数据')
...
'测试步骤3'
WebUI.comment('3.输入不存在的产品ID搜索不到数据')
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/input_产品ID搜索框'), GlobalVariable.product_Id_notExsit)
