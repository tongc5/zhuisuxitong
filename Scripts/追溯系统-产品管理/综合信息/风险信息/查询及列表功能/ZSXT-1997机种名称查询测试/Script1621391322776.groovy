...
'检查是否查询到产品信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/td_机种名称SEED-10IA'), 5)

'测试步骤2'
WebUI.comment('2.输入存在的机种名称可以搜索到数据')
...
'测试步骤3'
WebUI.comment('3.输入不存在的机种名称搜索不到数据')
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/input__机种名称搜索框'), GlobalVariable.model_name_notExsit)
