...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/input_风险原因输入框'), string_501)

WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/button_录入确定'))

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/div_风险原因长度不能超过500位'), 0)
