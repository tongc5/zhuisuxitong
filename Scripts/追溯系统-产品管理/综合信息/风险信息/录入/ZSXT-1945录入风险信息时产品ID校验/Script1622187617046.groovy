...
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/div_请输入产品ID'), 0)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/input_产品ID输入框'), GlobalVariable.product_Id_14)

WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/button_录入确定'))

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/风险信息/录入/div_产品ID必须为15或16位'), 0)
