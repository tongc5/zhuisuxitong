...
'测试步骤1'
WebUI.comment('1.在设备号文本框中输入存在的机设备号，点击查询按钮')
...
'检查是否查询到产品信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/td_设备机号DX10001'), 5)

'测试步骤2'
WebUI.comment('2.在设备号文本框中输入不存在的设备号，点击查询按钮')
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/input__设备机号搜索框'), GlobalVariable.device_num_notExsit)
...
WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/input__设备机号搜索框'), GlobalVariable.device_num1)
...
'检查是否查询到产品信息'
WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/td_设备机号包含DX'), 5)
