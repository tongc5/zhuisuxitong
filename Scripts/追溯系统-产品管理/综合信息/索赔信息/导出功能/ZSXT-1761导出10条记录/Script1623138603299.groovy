...
'测试步骤1'
WebUI.comment('1.搜索出10条记录，点击导出按钮')
...
WebUI.uploadFile(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/批量导入'), GlobalVariable.claim_path8)

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/span_导入成功10条'), 0)

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/input_产品ID搜索框'), GlobalVariable.product_Id_14)
