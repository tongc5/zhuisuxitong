...
WebUI.uploadFile(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/批量导入'), GlobalVariable.claim_path)

WebUI.verifyElementPresent(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/span_导入成功1条'), 0)
