...
WebUI.click(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/录入/a_今天'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/编辑/input__差旅经费输入框'), free)

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/编辑/input_产品ID输入框'), GlobalVariable.product_Id)

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/编辑/input__设备机号输入框'), GlobalVariable.device_num1)

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/编辑/input__其他费输入框'), free)

WebUI.setText(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/编辑/input__备注输入框'), free)
...
WebUI.uploadFile(findTestObject('追溯系统/业务管理/产品管理/综合信息/索赔信息/编辑/附件上传'), GlobalVariable.claim_path)
